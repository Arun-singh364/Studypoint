...
{
    public partial class CourseSubjects : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                SqlDataSource1.SelectCommand = "SELECT SUBID,SUB FROM [CourseSubTable] where COURSEID='" + Request.QueryString["id"]+"'";
