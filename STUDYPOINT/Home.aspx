<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="STUDYPOINT.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
      <asp:Panel ID="Panel3" runat="server" style="margin-top:150px;   height:350px; width:100%;">
                  ...
                  <div style="width:40%; height:350px; float:left; background-color:transparent;">
                      ...
                      <a  type="button"  style="font-size:25px; margin-top:35px; margin-left:40px;width:70%; height:60px;" class="btn btn-outline-primary " href="AllCourse.aspx">All Courses</a>
                      <a type="button"  style=" font-size:25px; margin-top:35px; margin-left:40px;width:70%; height:60px;" class="btn btn-outline-primary " href="AllSubject.aspx">All Subjects</a>
                      <a type="button"  style=" font-size:25px; margin-top:35px; margin-left:40px;width:70%; height:60px;" class="btn btn-outline-primary " href="PaidCourse.aspx">Paid Tutorials</a>
                      <a type="button"  style=" font-size:25px; margin-top:35px; margin-left:40px;width:70%; height:60px;" class="btn btn-outline-primary " href="Search.aspx" >Search</a>
